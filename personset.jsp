...
<form action="updatesUser.do?uid=<%=currentUser.getStudentId()%>" method="post" onsubmit="return checkForm();">
  <fieldset class="step">
  ...
  <tr>
    ...
    <td><input id="" type="text" name="teachernum" value="<%=currentUser.getStudentId()%>" readonly/></td>
  </tr>
  <tr>
    <th><label for="name">姓名:</label></th>
    <td><input id="" type="text" name="name" value="<%=currentUser.getsName()%>" readonly/></td>
  </tr>
  <tr>
    <th><label for="nikname">昵称:</label></th>
    <td><input id="nikname" type="text" name="nikname" value="<%=currentUser.getSnikname()%>"/></td>
  </tr>
  <tr>
    <th><label for="email">邮箱:</label></th>
    <td><input id="email" type="text" name="email" value="<%=currentUser.getSemail()%>"/></td>
  </tr>
  <tr>
    <th><label for="password">当前密码:</label></th>
    <td><input id="" type="password" name="password" value="<%=currentUser.getSpwd()%>" readonly/></td>
  </tr>
  <tr>
